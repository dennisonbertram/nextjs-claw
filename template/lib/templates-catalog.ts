...
export const TEMPLATES: TemplateEntry[] = [
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-emerald-900 via-neutral-900 to-black' },
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-neutral-800 via-neutral-900 to-black' },
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-indigo-950 via-purple-950 to-neutral-950' },
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-amber-900 via-neutral-900 to-black' },
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-rose-950 via-amber-900 to-neutral-950' },
  ...
  },
  {
    ...
    preview: { kind: 'gradient', className: 'bg-gradient-to-br from-teal-900 via-cyan-950 to-neutral-950' },
